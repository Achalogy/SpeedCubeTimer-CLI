...
def printCube(w, y, r, o, b, g, better):

    hexcodes_colors = []

    for color in ["white", "yellow", "red", "orange", "blue", "green"]:
        hexcodes_colors.append(
            src.settings.read_conf("better_visual_scramble", color)
        )

    colors_initials = {
        "W" : bg(hexcodes_colors[0]) + " W",
        "Y" : bg(hexcodes_colors[1]) + " Y",
        "R" : bg(hexcodes_colors[2]) + " R",
        "O" : bg(hexcodes_colors[3]) + " O",
        "B" : bg(hexcodes_colors[4]) + " B",
        "G" : bg(hexcodes_colors[5]) + " G"
    }

    colors = {
        "W" : bg(hexcodes_colors[0]) + " ",
        "Y" : bg(hexcodes_colors[1]) + " ",
        "R" : bg(hexcodes_colors[2]) + " ",
        "O" : bg(hexcodes_colors[3]) + " ",
        "B" : bg(hexcodes_colors[4]) + " ",
        "G" : bg(hexcodes_colors[5]) + " "       
    }

    initial = src.settings.read_conf("timer", "show_faces_initials")

    for layer in [w, y, r, o, b, g]:
        for row in layer:
            for color in row:
                if initial == "True":
                    layer[layer.index(row)][row.index(color)] = colors_initials[color]
                else:
    ...
    if initial == True:
        ...
        print("")
        print("\033[30;40m" + "             " + w[0][0] + " " + w[0][1] + " " +  w[0][2], end= " \033[0;40m\n\r")
        print("\033[30;40m" + "             " + w[1][0] + " " + w[1][1] + " " +  w[1][2], end= " \033[0;40m\n\r")
        print("\033[30;40m" + "             " + w[2][0] + " " + w[2][1] + " " +  w[2][2], end= " \033[0;40m\n\r")    
        print("", end= "\n\r")
        print("\033[30;40m" + "     " + o[0][0] + " " + o[0][1] + " " + (o[0][2] + " ") + "\033[30;40m" + "  " + g[0][0] + " " + g[0][1] + " " + (g[0][2] + " ") + "\033[30;40m" + "  " + r[0][0] + " " + r[0][1] + " " + (r[0][2] + " ") + "\033[30;40m" + "  " + b[0][0] + " " + b[0][1] + " " + b[0][2], end= " \033[0;40m\n\r")
        print("\033[30;40m" + "     " + o[1][0] + " " + o[1][1] + " " + (o[1][2] + " ") + "\033[30;40m" + "  " + g[1][0] + " " + g[1][1] + " " + (g[1][2] + " ") + "\033[30;40m" + "  " + r[1][0] + " " + r[1][1] + " " + (r[1][2] + " ") + "\033[30;40m" + "  " + b[1][0] + " " + b[1][1] + " " + b[1][2], end= " \033[0;40m\n\r")
        print("\033[30;40m" + "     " + o[2][0] + " " + o[2][1] + " " + (o[2][2] + " ") + "\033[30;40m" + "  " + g[2][0] + " " + g[2][1] + " " + (g[2][2] + " ") + "\033[30;40m" + "  " + r[2][0] + " " + r[2][1] + " " + (r[2][2] + " ") + "\033[30;40m" + "  " + b[2][0] + " " + b[2][1] + " " + b[2][2], end= " \033[0;40m\n\r")
        print("", end= "\n\r")
        print("\033[30;40m" + "             " + y[0][0] + " " + y[0][1] + " " + y[0][2], end= " \033[0;40m\n\r")
        print("\033[30;40m" + "             " + y[1][0] + " " + y[1][1] + " " + y[1][2], end= " \033[0;40m\n\r")
        print("\033[30;40m" + "             " + y[2][0] + " " + y[2][1] + " " + y[2][2], end= " \033[0;40m\n\r")    
        print("")
